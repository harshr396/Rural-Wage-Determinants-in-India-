...
The independent variables are:- 
	- Population (pop),
	- Net State Value Added by Agriculture (NSV A agri),
	- Net State Value Added by Industries (NSV A ind),
	- Net State Value Added by Construction (NSV A constru)
...
## Files
	...
	- Rural_Wage_Analysis_Report.pdf (Research Paper)
	- rural_wage_regression.R (Code)
